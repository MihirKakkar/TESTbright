...
function processVideo(video) {
    ...
    setTimeout(() => {
      document.body.innerHTML = "<h1> Testosterone concentration: " + Number(Math.trunc((Math.exp((peakBlueIntensity - 51.7)/(-6.21)))).toPrecision(2)) + "± " + Number((Math.exp((peakBlueIntensity - 51.7)/(-6.21))) * 0.18).toPrecision(1) + " ng/mL</h1>"
    }, 10000)
}
